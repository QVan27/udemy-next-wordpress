...
export const PropertyFeatures = ({ price, bedrooms, bathrooms, petFriendly, hasParking }) => {
  return (
    <div className='max-w-lg mx-auto my-10 bg-white text-slate-500 p-5 text-center'>
